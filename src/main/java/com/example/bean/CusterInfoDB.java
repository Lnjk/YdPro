...
public class CusterInfoDB {
	...
	public static class Users {
		...
		public String toString() {
			return "Users [device_Id=" + device_Id + ", device_image="
					+ device_image + ", signature=" + signature
					+ ", signaturePWD=" + signaturePWD + ", user_Cust="
					+ user_Cust + ", user_DB=" + user_DB + ", user_Dep="
					+ user_Dep + ", user_Id=" + user_Id + ", user_Mod="
					+ user_Mod + ", user_Name=" + user_Name + ", user_Pwd="
					+ user_Pwd + ", user_Query=" + user_Query + ", user_date="
					+ user_date + ", user_erpUser=" + user_erpUser + "]";
		}
	...
	public static class User_Query {
		...
		private String user;
		private String user_id;
		public User_Query(String query_DB, String query_Cust,
				String query_Dep, String query_Sup,String query_CompDep, String query_User) {
			super();
		...
		public String toString() {
			return "User_Query [accountDB=" + accountDB + ", query_Cust="
					+ query_Cust + ", query_DB=" + query_DB + ", query_Dep="
					+ query_Dep + ", query_Sup=" + query_Sup + ", query_User="
					+ query_User + ", query_CompDep=" + query_CompDep
	...
	public static class User_Mod {
		...
		public User_Mod(String db_ID,String mod_ID, String mod_Name, boolean mod_Add,
				boolean mod_Alter, boolean mod_Amt, boolean mod_Cst,
				boolean mod_Del, boolean mod_GP, boolean mod_GPR,
				boolean mod_Out, boolean mod_Prt, boolean mod_Qty,
				boolean mod_Query, boolean mod_Up) {
			super();
			this.db_ID = db_ID;
		...
		public String toString() {
			return "User_Mod [accountDB=" + accountDB + ", db_ID=" + db_ID
					+ ", level=" + level + ", mod_Add=" + mod_Add
					+ ", mod_Alter=" + mod_Alter + ", mod_Amt=" + mod_Amt
					+ ", mod_Cst=" + mod_Cst + ", mod_Del=" + mod_Del
					+ ", mod_GP=" + mod_GP + ", mod_GPR=" + mod_GPR
					+ ", mod_ID=" + mod_ID + ", mod_Name=" + mod_Name
					+ ", mod_Out=" + mod_Out + ", mod_Prt=" + mod_Prt
					+ ", mod_Qty=" + mod_Qty + ", mod_Query=" + mod_Query
					+ ", mod_Up=" + mod_Up + ", module_List=" + module_List
					+ ", user=" + user + ", user_ID=" + user_ID + "]";
		}
